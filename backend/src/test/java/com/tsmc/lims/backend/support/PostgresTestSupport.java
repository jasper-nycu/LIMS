package com.tsmc.lims.backend.support;
...
public final class PostgresTestSupport {
    ...
    private static final String DB_PASSWORD = valueOrDefault("DB_PASSWORD", "SuperSecretPassword");
    private static final String BASE_URL = "jdbc:postgresql://localhost:5432/" + DB_NAME;

    private PostgresTestSupport() {
    }

    public static void configure(DynamicPropertyRegistry registry, String schemaName) { 
