...
public class AuthService {
    ...
    private void sendTotpEmail(String toAddress, String code) {
        ...
        message.setSubject("LIMS Portal - Your Verification Code");
        message.setText("Welcome to LIMS.\n\nYour 6-digit verification code is: " + code + 
                        "\n\nThis code will expire shortly. Do not share this with anyone.");
        
        // Execute mail dispatch (Warning: Ensure spring.mail properties are correct, 
        // or this will throw a MailException during testing)
